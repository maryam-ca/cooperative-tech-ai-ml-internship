...
_SVG_PATHS = {
    ...
    "settings": '<circle cx="12" cy="12" r="3.2"/><path d="M19.4 13.5a7.8 7.8 0 0 0 .1-.9l1.6-1.2-.9-1.6-1.9.7a7.4 7.4 0 0 0-1.6-1.5l.2-2-1.7-.7-1.3 1.5a7.5 7.5 0 0 0-2.2 0L7.9 6l-1.7.7.2 2a7.4 7.4 0 0 0-1.6 1.5l-1.9-.7-.9 1.6 1.6 1.2a7.8 7.8 0 0 0 .1.9l-1.6 1.3.9 1.6 1.9-.7a7.4 7.4 0 0 0 1.6 1.5l-.2 2 1.7.7 1.3-1.5a7.5 7.5 0 0 0 2.2 0l1.3 1.5 1.7-.7-.2-2a7.4 7.4 0 0 0 1.6-1.5l1.9.7.9-1.6-1.6-1.3z"/>',
